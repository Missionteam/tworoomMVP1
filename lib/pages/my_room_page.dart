...
class MyRoomPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _MyRoomPageState();
}
...
class _MyRoomPageState extends ConsumerState<MyRoomPage> {
  ...
  Future<void> sendPost(String text) async {
    ...
    final roomId = ref.watch(uidProvider)!; //ここでは、ルームIdはuid
  ...
  Widget build(BuildContext context) {
    ...
    final currentRoomName = '${appUserName}のつぶやき部屋';
    final roomId = ref.watch(uidProvider) ?? ''; //このクラスでは、RoomId=uid。
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(currentRoomName, style: TextStyle(color: Colors.black)),
